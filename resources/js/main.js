...
function validateRegister() {
    ...
    if(userpass.length < 8) {
        document.getElementById("userpass").innerHTML = "**Password length must be atleast 8 characters";
        return false;
      }
  
      //maximum length of password validation
      if(userpass.length > 15) {
        document.getElementById("userpass").innerHTML = "**Password length must not exceed 15 characters";
        return false;
      }
